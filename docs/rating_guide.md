...
**Kazandık ama skorum çok az arttı. Neden?**
W/L artık skorun yalnızca %20'si. Ayrıca zayıf bir takımı yendiyseniz mu zaten
az artar. Skoru asıl oynatan, maç içi performansının kariyer ortalamana
(P_avg) etkisidir.

**Kaybettik ama skorum arttı. Bu nasıl oluyor?**
Olabilir — bilinçli bir tasarım kararı. Mu düşer, ama o maçta çok iyi
oynadıysan P_avg yükselir; %80'lik performans tarafı %20'lik W/L kaybını
telafi edebilir. Kısacası: **kaybeden takımda bile iyi oynamak boşa gitmez.**

**Stat kasarsam skor kasabilir miyim?**
Sınırlı. Her bileşen 2.0'da kırpılır, beş bileşenin ortalaması alınır ve takım
payları görecelidir: gereksiz farm kasmak takımın gold payını sana kaydırır ama
maçı kaybettirirse mu'dan yersin. Arkadaş grubu ölçeğinde bu risk kabul edildi.

**Maç iptal (void) edilirse ne olur?**
O maç hesaptan tamamen çıkarılır ve **tüm geçmiş yeniden hesaplanır** — sanki o
maç hiç oynanmamış gibi. Sistem her an sıfırdan aynı sonucu üretebilecek
şekilde kurulu.

**Yeni gelen arkadaşım neden 0'da?**
Herkes 0'dan başlar: nötr güç tahmini eksi tam belirsizlik. İlk maçlarıyla
birlikte skor hızla gerçek seviyesine oturur.
