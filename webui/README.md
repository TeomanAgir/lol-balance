...
- Profil görünümü üç yerden açılır (sıralama, enler, harita); geldiği görünümün sekmesi aktif kalır ve geri düğmesi ona göre "← Sıralamaya dön" / "← Enlere dön" / "← Haritaya dön" yazar (`state.profileFrom`).
