...
## Dizin
- `backend/app/routers/` — ingest, matches (PUT positions, void), players
  (+`/{id}/stats`), balance (`/balance`, `/balance/nemesis`), highlights, nemesis, admin (replay).
...
- `backend/tests/` — 122 test. Kalıp: geçici DB fixture'ları, spy/monkeypatch ile
